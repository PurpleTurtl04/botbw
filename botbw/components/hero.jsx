        ...
        <div className='hero'>
            ...
            <div className='hero-content px-0 md:mt-10'>
                <h1 className='xs:text-4xl text-center text-3xl sm:text-5xl md:max-w-none md:text-[54px] lg:text-7xl 2xl:text-8xl'>
                    <span className='font-pressStart text-base-content text-shadow-primary leading-12 [-webkit-text-stroke:3px_#0C1425] text-shadow-[4px_5px_0_#000] md:leading-20'>
